...
//////////////////////////////////////////////////////////////////////////            
    ...
    this.getFinalCart = function() {
        this.getCookieValues();
        var finalCart = new Array();
        for(i=0; i < this.skuArray.length; i++) {
            finalCart[i] = new Array();
            finalCart[i].push(this.skuArray[i]);
            finalCart[i].push(this.qtyArray[i]);
            finalCart[i].push(this.priceArray[i]);
            finalCart[i].push(this.qtyArray[i]*this.priceArray[i]);
            }
        return finalCart;
        }   
    ...
    this.emptyCart = function() {
        this.getCookieValues();
        this.skuArray.length = 0;
        this.qtyArray.length = 0;
